...
plt.plot(arrival_rates * NUM_NODES, throughput_cd, label='CSMA/CD', marker='o')
plt.plot(arrival_rates * NUM_NODES, throughput_dcr, label='CSMA/DCR', marker='s')
plt.xlabel("Network Load (Packets / Slot)")
plt.ylabel("Throughput")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.savefig('/home/cells/school/net/project1/latex/figures/throughput.png')

plt.figure(figsize=(6, 5))
plt.plot(arrival_rates * NUM_NODES, delay_cd, label='CSMA/CD', marker='o')
plt.plot(arrival_rates * NUM_NODES, delay_dcr, label='CSMA/DCR', marker='s')
plt.xlabel("Network Load (Packets / Slot)")
...
plt.legend()
plt.tight_layout()
plt.savefig('/home/cells/school/net/project1/latex/figures/delay.png')
